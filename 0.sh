...
wget --no-check-certificate -O out.xml "https://program-think.blogspot.com/feeds/comments/default?max-results=500"
sed 's/<entry>/\n<entry>/g' out.xml > cur.xml
tail -n +2 cur.xml > curr.xml
